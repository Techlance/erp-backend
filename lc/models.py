...
class lc(models.Model):
    ...
    party_code = models.ForeignKey(to=ledger_master, related_name="ledger_master1", null=False, on_delete=models.PROTECT)
    base_currency = models.ForeignKey(to=currency, null=False,default="1", on_delete=models.PROTECT)
    cost_center = models.ForeignKey(to=cost_center, null=False, on_delete=models.PROTECT)
    ...
    bank_ac =  models.ForeignKey(to=ledger_master, related_name="ledger_master2", null=True, on_delete=models.PROTECT)
...
class lc_docs(models.Model):
    ...
    lc_id = models.ForeignKey(to=lc, null=False, on_delete=models.PROTECT)
    company_master_id = models.ForeignKey(to=company_master,default=1, null=False, on_delete=models.PROTECT)
